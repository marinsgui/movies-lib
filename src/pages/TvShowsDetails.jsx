...
export default function TvShowsDetails() {
  ...
  useEffect(() => {
    const showUrl = `${showsURL}${id}?${apiKey}&language=pt-BR&region=BR`;
    getShow(showUrl);
  }, []);
        ...
        <section className="flex flex-col items-center gap-28">
          ...
          >
            <div className="inline-flex flex-col gap-2 w-72 md:min-w-[35rem] p-5 md:p-10 rounded-3xl bg-gray-800/70 backdrop-blur-md absolute -bottom-20 md:-bottom-14 left-4 md:left-14">
              <span className="text-xs text-indigo-300">MoviesLib / Show</span>
          ...
          <div className="flex flex-col md:flex-row gap-20">
            ...
            <div className="md:w-[30rem] flex flex-col items-start gap-10">
              ...
              <p className="md:text-xl text-gray-300">{show.overview}</p>
              ...
              <div className="flex flex-col flex-wrap  gap-10 h-[25rem]">
                <div>
                ...
                <div>
                  <h4 className="text-gray-400">Temporadas:</h4>
                  <span className="text-gray-100 text-lg md:text-xl">
                ...
                <div>
                  <h4 className="text-gray-400">Data de encerramento:</h4>
                  <span className="text-gray-100 text-lg md:text-xl">
                  {show.last_air_date &&
                      new Intl.DateTimeFormat("pt-BR").format(
                        Date.parse(show.last_air_date)
                      )}
                  </span>
                </div>
                <div>
                  <h4 className="text-gray-400">Episódios:</h4>
                  <span className="text-gray-100 text-lg md:text-xl">
              ...
              <div>
                ...
                <span className="text-gray-100 text-lg md:text-xl">
                  {show.genres?.[0]?.name}, {show.genres?.[1]?.name},{" "}
                  {show.genres?.[2]?.name}
                </span>
              </div>
            </div>
